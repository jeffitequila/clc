...
public class Jeff extends JFrame implements ActionListener {
    ...
    JButton jblimpar;
    JButton jbsair;
    JButton jbexecutar, jbcalcular_imc;
    JComboBox jcestado, jccidade, jcprofissao ;
        ...
        public Jeff(){
            ...
            */
            ...
            jbcalcular_imc = new JButton("CALCULAR I.M.C");
            add(jbcalcular_imc);
            jbcalcular_imc.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource()==tfNome){
            ...
            jcprofissao.setSelectedIndex(0);
            tfaltura.setText(" ");
            tfpeso.setText(" ");
            tfimc.setText(" ");
        ...
        else if (ae.getSource()== jbcalcular_imc){
            CalculoIMC calculoimc = new CalculoIMC() ;
            double imc =  calculoimc.calculo(Double.parseDouble(tfpeso.getText()), Double.parseDouble(tfaltura.getText()));
            tfimc.setText(String.format("%.1f " , imc));
